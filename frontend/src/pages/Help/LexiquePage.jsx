...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Entrée en stock suite à un achat fournisseur. Le stock augmente. Lié à un bon de réapprovisionnement (REAP-).',
        icon: TrendingUp,
      },
      {
        term: 'sale',
      ...
      },
      {
        term: 'return',
        label: 'Retour client',
        description: 'Retour d\'un article par un client. Le stock est réintégré. Ce mouvement doit être validé par un administrateur.',
        icon: RefreshCw,
      },
      {
        term: 'correction',
        label: 'Correction manuelle',
        description: 'Ajustement de stock effectué par un administrateur depuis la page « Mouvements de stock ». Utilisé pour corriger les inventaires ou la casse.',
        icon: Package,
      },
      {
        term: 'loss',
  ...
  },
  {
    ...
    color: 'var(--blue-600)',
    items: [
      { term: 'cash', label: 'Espèces', description: 'Paiement en espèces (billets et pièces). Le système calcule automatiquement la monnaie à rendre.' },
      { term: 'mtn', label: 'MTN Mobile Money', description: 'Paiement via l\'application MTN MoMo. Aucun rendu de monnaie automatique.' },
      { term: 'moov', label: 'Moov Money', description: 'Paiement via l\'application Moov Money / Flooz. Aucun rendu de monnaie automatique.' },
      { term: 'celtiis', label: 'Celtiis Money', description: 'Paiement via l\'application Celtiis Money. Aucun rendu de monnaie automatique. Disponible sur le réseau Celtiis au Bénin.' },
      { term: 'card', label: 'Carte bancaire', description: 'Paiement par carte de débit ou crédit via terminal de paiement.' },
      { term: 'transfer', label: 'Virement bancaire', description: 'Paiement par virement bancaire ou mobile banking. Souvent utilisé pour les transactions B2B importantes.' },
      { term: 'mixed', label: 'Paiement Mixte', description: 'Paiement combinant plusieurs moyens de paiement. Ex: une partie en espèces + Mobile Money.' },
    ],
  },
  {
    id: 'product',
    ...
    color: 'var(--blue-400)',
    items: [
      { term: 'SKU', label: 'Stock Keeping Unit', description: 'Code unique d\'identification interne d\'un produit. Généré automatiquement si non fourni. Format : ex. « SKU-00042 ».' },
      { term: 'Marge brute', label: 'Marge commerciale', description: 'Différence entre le prix de vente et le prix d\'achat, exprimée en pourcentage. Formule : (Vente - Achat) / Achat × 100.' },
  ...
  },
  {
    ...
    items: [
      ...
      { term: 'Annulation', label: 'Annulation de vente', description: 'Opération réservée aux administrateurs. Annule une vente et restitue automatiquement les quantités au stock via un mouvement de retour.' },
      ...
      { term: 'CA', label: 'Chiffre d\'Affaires', description: 'Total des ventes sur une période donnée, hors remises, hors taxes. Visible dans les rapports et le tableau de bord.' },
      { term: 'Bénéfice net', label: 'Marge réalisée', description: 'Différence totale entre les prix de vente et les prix d\'achat de tous les articles d\'une vente. Indiqué dans le détail de chaque vente.' },
    ],
  },
]
